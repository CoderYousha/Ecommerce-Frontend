...
function Employees() {
    ...
    const [employeessCounts, setEmployeesCounts] = useState();
                                            ...
                                            <TableContainer className="" component={Paper} dir={language === 'en' ? 'ltr' : "rtl"}>
                                                ...
                                                <Box className="min-h-12 py-2 px-2 flex justify-between items-center max-sm:flex-col">
                                                    ...
                                                    <Box className="flex w-2/4 items-center justify-end max-sm:mt-2 max-sm:w-full max-sm:justify-between">
                                                        ...
                                                        <Typography variant="body1" className="!text-gray-500"><FormattedMessage id='total_employees' />: {employeessCounts}</Typography>
                                                    </Box>
                                                </Box>
                                                ...
                                                <Table className="" sx={{ minWidth: 700 }} aria-label="customized table">
                                                    ...
                                                    <TableBody>
                                                        {employees.map((employee, index) => (
                                                            <StyledTableRow key={index} onClick={() => employeeDetails(employee.id)} className="hover:bg-gray-200 duration-100 cursor-pointer">
                                                                ...
                                                                <StyledTableCell align="right" className="!flex justify-around items-center">
                                                                    <Button variant="contained" className="!bg-red-300 !font-bold !text-red-800 hover:!bg-red-500 hover:!text-white duration-300" onClick={(e) => { e.stopPropagation(); setPopup('withdraw', 'flex') }}><FormattedMessage id='delete' /></Button>
                                                                    <Button variant="contained" className="!bg-green-300 !font-bold !text-green-800 hover:!bg-green-500 hover:!text-white duration-300" onClick={(e) => { e.stopPropagation(); setPopup('withdraw', 'flex') }}><FormattedMessage id='update' /></Button>
                                                                </StyledTableCell>
                                                            </StyledTableRow>
                                                        ))}
                                                    </TableBody>
