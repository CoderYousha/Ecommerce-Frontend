...
function Categories() {
    ...
    const deleteCategory = async () => {
        let result = await Fetch(host + `/admin/categories/${category.id}`, 'DELETE', null);
                                                            ...
                                                            <StyledTableRow key={index} className="hover:bg-gray-200 duration-100 cursor-pointer">
                                                                ...
                                                                <StyledTableCell align="right">
                                                                    <Box className="!flex justify-center items-center">
                                                                        <Button variant="contained" className="!bg-red-300 !font-bold !text-red-800 hover:!bg-red-500 hover:!text-white duration-300 !mr-2" onClick={(e) => { categoryDetails(category.id); setPopup('delete', 'flex') }}><FormattedMessage id='delete' /></Button>
